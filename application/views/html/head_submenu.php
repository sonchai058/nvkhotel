<div class="w_main_subhead">
	<div class="main_subhead">
		...
		<ul class="menu">
			...
			<li><a href="#" class="wobble" title="Member info">Member info</a></li>
			<li><a href="#" class="wobble" title="Hotel info">Hotel info</a></li>
			<li><a href="#" class="wobble" title="Packkage info">Packkage info</a></li>
...
<ul class="menu_small">
	<li><a href="<?php echo base_url('control/website_setting');?>" title="Website Setting">Website Setting</a></li>
	<li><a href="#" title="Member info">Member info</a></li>
	<li><a href="#" title="Hotel info">Hotel info</a></li>
	<li><a href="#" title="Packkage info">Packkage info</a></li>
